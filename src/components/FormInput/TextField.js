...
import { TextInput, View, Text, TextInputProps, Image, TouchableOpacity } from "react-native";
...
const TextField: React.FC<TextInputProps | CustomProps>
    = ({
        ...
        <View>
            ...
            <View style={[styles.main, containerStyle, { borderColor: errMsg || isError ? Colors.Danger : Colors.InputField }]}>
                {prefixIcon && (
                    <View
                        style={[styles.prefixContainer, prefixStyle]}
                    >
                        {prefixIcon}
                    </View>
                )}
                ...
                <TextInput
                    ...
                    { width: (suffixIcon && prefixIcon) ? "75%" : (suffixIcon || prefixIcon) ? prefixStyle ? "70%" : "85%" : "100%" }
                    ]}
                    ref={reference}
            ...
            {errMsg ?
                <Text style={[styles.errMsgStyle, errorStyle]}>{errMsg}</Text> : null}
        </View>
    )
